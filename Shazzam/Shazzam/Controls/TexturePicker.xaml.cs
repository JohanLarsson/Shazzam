...
namespace Shazzam.Controls
{
	...
	public partial class TexturePicker : UserControl
	{
		...
		private void SetupTextures()
		{
			...
			{
				cboIncludedTextures.Items.Add(System.IO.Path.GetFileName(file));
			}
		}
		private void SetupTextures2()
		{
			...
			foreach (var entry in maps)
			{
				...
				//}
				cboIncludedTextures.Items.Add(entry);
		...
		private void cboIncludedTextures_SelectionChanged(object sender, SelectionChangedEventArgs e)
		{
			...
			string uriLocation = string.Format("images/texturemaps/{0}", cboIncludedTextures.SelectedItem.ToString());
			...
			Uri resourceUri = new Uri(uriLocation, UriKind.Relative);
